    ...
    <>
      <div className="flex relative md:gap-28 gap-20">
        <div className="relative">
          ...
          {/* <div className="eyelashed absolute w-full h-full flex gap-4 flex-nowrap bg-red-200/40 rounded-full">
            <span className="border border-black bg-black w-[2.4px] h-4 -rotate-12"></span>
            <span className="border border-black bg-black w-[2.4px] h-4 -rotate-12"></span>
            <span className="border border-black bg-black w-[2.4px] h-4 -rotate-12"></span>
            <span className="border border-black bg-black w-[2.4px] h-4 -rotate-12"></span>
            <span className="border border-black bg-black w-[2.4px] h-4 -rotate-12"></span>
        ...
        <div className="relative">
          ...
          {/* <div className="eyelashed absolute w-full h-full flex gap-4 flex-nowrap bg-red-200 rounded-full">
            <span className="border border-black bg-black w-[2.4px] h-4 -rotate-12"></span>
            <span className="border border-black bg-black w-[2.4px] h-4 -rotate-12"></span>
            <span className="border border-black bg-black w-[2.4px] h-4 -rotate-12"></span>
            <span className="border border-black bg-black w-[2.4px] h-4 -rotate-12"></span>
