        ...
        <Header/>
          ...
          <div className=' mx-auto mt-10 md:mt-0 py-10 px-4 md:px-24 '>
            <div className="flex items-center flex-col-reverse gap-10 md:gap-0 md:flex-row justify-center">
                ...
                <div className=' w-[70%] md:w-auto'>
                    <img src={illustraterGif} alt="illustraterGif" />
                </div>
            </div>
          </div>
          {/* ********************************************************************* */}
          <div className='mx-auto mt-24 md:mt-0 md:py-10 px-2 md:px-24'>
            <p className='text-2xl font-semibold text-[#005323] pb-6'>Scroll to  have some UX Tea</p>
          ...
          <div className='container mx-auto md:my-[50px]'>
            <div className='eventify flex items-center flex-col md:flex-row'>
                ...
                <div className='w-2/5 '>
                    ...
                    <div className='font-semibold text-[22px] text-transparent bg-clip-text bg-gradient-to-b from-[#4252DD] from-0% via-[#0ABCA7] via-40% to-[#3E5AD9] to-90%'>Finding & Hosting Events in your locality</div>
                    <div className='text-sm text-[#717171] pt-1'>Your go-to app for seamless event discovery and community connection in your nearby area.</div>
                    </div>
          ...
          <div className='container mx-auto my-[120px]'>
            <div className='fitverx flex items-center flex-col md:flex-row'>
                ...
                <div className='flex-1'>
                <div className='details flex flex-col px-5 md:px-0 md:w-[60%] mx-auto md:mx-0'>
                    <div className='font-semibold text-[22px] text-transparent bg-clip-text bg-gradient-to-b from-[#000000] to-[#666666] '>Fitverx</div>
                    <div>

                    <div className='font-semibold text-[22px] text-transparent bg-clip-text bg-gradient-to-b from-[#4252DD] from-0% via-[#0ABCA7] via-40% to-[#3E5AD9] to-90%'>Get a Virtual trial before you buy</div>
                    <div className='text-sm text-[#717171] pt-1'>Our innovative virtual try-on technology, select the items you love, and with a click, see yourself wearing them in real-time.</div>
                    </div>
          ...
          <div className='container mx-auto my-[120px]'>
            <div className='pinterest flex items-center flex-col md:flex-row'>
                ...
                <div className='details flex flex-col px-5 md:px-0 md:w-[60%] mx-auto md:mx-0'>
                    ...
                    <div>
                    <div className='font-semibold text-[22px] text-transparent bg-clip-text bg-gradient-to-b from-[#BD081C] to-[#000000]'>Redesigning Pinterest</div>
                    <div className='text-sm text-[#717171] pt-1'>Delve into the intricacies of Pinterest's seeking opportunities for improvement and explore potential enhancements to the user experience."</div>
                    </div>
          ...
          {/* ******************************************************************************************* */}
            <div className='container mx-auto my-[120px] px-5 md:px-0'>
                <div className='text-2xl font-Bree text-[#005323]'>Made with lots of love and caffeine.</div>
